...
import { getDashboard, downloadCertificateUrl, seedDemoCertificate, deleteDemoCertificates } from "@/api/dashboard.api";
...
type Tab = "courses" | "orders" | "certificates" | "profile";
            ...
            <div className="flex-1 lg:ml-64 min-w-0">
                ...
                <main className="px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    {activeTab === "certificates" && (
                        <div>
                            <CertificateSection isAdmin={isAdmin} />
                        </div>
                    )}

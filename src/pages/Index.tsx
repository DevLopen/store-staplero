...
const Index = () => {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            {/* Google Reviews Section - NOW WITH WIDGET */}
            <section className="py-24 bg-muted/50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center py-12 text-muted-foreground">
                            ...
                            <p className="text-sm">
                                <a
                                    href="https://share.google/jEXeXAffDcGwnq8Qj"
                                    target="_blank"
                            ...
                            <CarouselItem className="pl-2 md:pl-4 basis-[85%] md:basis-1/2 lg:basis-1/3">
                                <div className="relative bg-card rounded-3xl p-6 shadow-xl border-2 border-primary overflow-hidden">
                                    ...
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">netto (+ 19% MwSt.)</p>
                                    </div>

                                    <div className="space-y-3 mb-6">
                                        {[
                                            "2 Tage Ausbildung",
                                            "Theoreie offline & Praxis",

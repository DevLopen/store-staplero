import { Course, QuizResult, UserProgress } from "@/types/courseData"; // dostosuj ścieżkę
...
export const isChapterAccessible = (chapterId: string, progress: Record<string, boolean>, quizResults: Record<string, QuizResult>, course?: Course): boolean => {
...
export const needsQuiz = (chapterId: string, progress: Record<string, boolean>, quizResults: Record<string, QuizResult>, course?: Course): boolean => {
...
export const getFirstAccessibleTopic = (chapterId: string, progress: Record<string, boolean>, quizResults: Record<string, QuizResult>, course?: Course): string | null => {
    const chapter = course?.chapters.find(ch => ch.id === chapterId);
